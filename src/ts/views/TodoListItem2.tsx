    ...
    private _onRenderItem = (isHovering: boolean) => {
        ...
        return (
            <RX.View style={buttonStyles}>
                ...
                {this.props.todo.text === 'Image NFT' ? <BsImages style={{ width: 20, height: 20 }} /> : null}
                {this.props.todo.text === '3D Object NFT' ? <MdPermMedia style={{ width: 20, height: 20 }} /> : null}

                {this.props.todo.text === 'Swap Token' ? <AiOutlineSwap style={{ width: 20, height: 20 }} /> : null}
                {this.props.todo.text === 'Initial Coin Offering' ? <MdLocalOffer style={{ width: 20, height: 20 }} /> : null}
